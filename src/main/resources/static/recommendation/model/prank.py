...
class Graph:
    ...
    def _gen_user_graph(cls, user_id):
        ...
        item_ids = list(set(cls.frame[cls.frame['user_id'] == user_id]['car_id']))
    ...
    def _gen_item_graph(cls, item_id):
        ...
        user_ids = list(set(cls.frame[cls.frame['car_id'] == item_id]['user_id']))
    ...
    def gen_graph(cls):
        ...
        user_ids = list(set(cls.frame['user_id']))
        item_ids = list(set(cls.frame['car_id']))
...
class PersonalRank:
    ...
    def predict(self, user_id, top_n=10):
        ...
        item_ids = ['item_' + str(item_id) for item_id in list(set(frame[frame['user_id'] == user_id]['car_id']))]
