...
class Corpus:
    ...
    def pre_process(cls):
        ...
        cls.item_ids = set(cls.frame['car_id'].values)
    ...
    def _get_pos_neg_item(cls, user_id):
        ...
        pos_item_ids = set(cls.frame[cls.frame['user_id'] == user_id]['car_id'])
...
class LFM:
    ...
    def _init_model(self):
        ...
        self.item_ids = set(self.frame['car_id'].values)
    ...
    def predict(self, user_id, top_n=10):
        ...
        """
        self.load()
        user_item_ids = set(self.frame[self.frame['user_id'] == user_id]['car_id'])
